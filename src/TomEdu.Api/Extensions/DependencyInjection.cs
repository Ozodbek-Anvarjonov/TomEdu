...
using TomEdu.Api.ExceptionHandlers;
using TomEdu.Api.Routing;
using TomEdu.Api.Services;
using TomEdu.Application.Abstractions.Caching.Settings;
...
namespace TomEdu.Api.Extensions;
...
public static class DependencyInjection
{
    ...
    private static IServiceCollection AddCredentials(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // email
        services.Configure<RegisterEmailNotificationCredentialOptions>(configuration.GetSection("NotificationCredentials:Email:Register"));
        services.Configure<LoginEmailNotificationCredentialOptions>(configuration.GetSection("NotificationCredentials:Email:Login"));
        services.Configure<ChangePasswordEmailNotificationCredentialOptions>(configuration.GetSection("NotificationCredentials:Email:ChangePassword"));
        // sms
        services.Configure<RegisterSmsNotificationCredentialOptions>(configuration.GetSection("NotificationCredentials:Sms:Register"));
        services.Configure<LoginSmsNotificationCredentialOptions>(configuration.GetSection("NotificationCredentials:Sms:Login"));
        services.Configure<ChangePasswordSmsNotificationCredentialOptions>(configuration.GetSection("NotificationCredentials:Sms:ChangePassword"));
